 ...
 * @since 1.0.0
 */
@HttpHandlerMarker(value = HttpDelete.class)
public class HttpDeleteHandler extends AbstractHttpHandler {

    public HttpDeleteHandler(HRpcConfiguration hRpcConfiguration) {
    ...
    public Annotation handleAnnotation(Method target) {
        HttpDelete httpDelete = target.getAnnotation(HttpDelete.class);
        return httpDelete;
    }
}
